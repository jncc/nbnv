...
public class UserTokenResource {
    private static final int DEFAULT_TOKEN_TTL = 1000;
    ...
    public Response getTaxonNavigationGroup(
        ...
        return Response.ok()
           .cookie(new NewCookie(TokenUserProvider.TOKEN_COOKIE_KEY, Base64.encodeBase64URLSafeString(token.getBytes())))
           .build();
    }
}
