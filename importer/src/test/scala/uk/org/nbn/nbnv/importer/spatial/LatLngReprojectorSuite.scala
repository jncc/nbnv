...
class LatLngReprojectorSuite extends BaseFunSuite {
  ...
  test("should give correct easting & northing for Lat 52.5856676 lng -0.22174100 in the OSGB projection") {
    val rpj = new LatLngReprojector
    val (easting, northing) = rpj.reproject(52.585667, -0.22174100, "27700")

    println("Easting: " + easting.toString)
    println("Northing: " + northing.toString)
    easting should be (520574 plusOrMinus 50)
    northing should be (300136 plusOrMinus 50)
  }
}
