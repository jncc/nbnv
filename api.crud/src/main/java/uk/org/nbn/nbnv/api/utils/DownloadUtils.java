...
public class DownloadUtils {
    ...
    public List<String> createDatasetList(DownloadFilterJSON download, List<String> species, User user) {
        ...
        if (download.getDataset().isAll()) {
            List<TaxonDatasetWithQueryStats> selectRequestableObservationDatasetsByFilter = taxonObservationMapper.selectRequestableObservationDatasetsByFilter(user, download.getYear().getStartYear(), download.getYear().getEndYear(), new ArrayList<String>(), species, download.getSpatial().getMatch(), download.getSpatial().getFeature(), (download.getSensitive().equals("sans")), download.getTaxon().getDesignation(), download.getTaxon().getOutput(), download.getTaxon().getOrgSuppliedList(), "", "");
    ...
    public List<String> createDatasetList(DownloadFilterJSON download, List<String> species, Organisation org) {
        ...
        if (download.getDataset().isAll()) {
            List<TaxonDatasetWithQueryStats> selectRequestableObservationDatasetsByFilter = taxonObservationMapper.selectRequestableObservationDatasetsByFilterOrganisation(org, download.getYear().getStartYear(), download.getYear().getEndYear(), new ArrayList<String>(), species, download.getSpatial().getMatch(), download.getSpatial().getFeature(), (download.getSensitive().equals("sans")), download.getTaxon().getDesignation(), download.getTaxon().getOutput(), download.getTaxon().getOrgSuppliedList(), "", "");
            datasets = new ArrayList<String>();
    ...
    public List<String> createSensitiveDatasetList(DownloadFilterJSON download, List<String> species, Organisation org) {
        ...
        List<TaxonDatasetWithQueryStats> selectRequestableSensitiveObservationDatasetsByFilter = taxonObservationMapper.selectRequestableSensitiveObservationDatasetsByFilterOrganisation(org, download.getYear().getStartYear(), download.getYear().getEndYear(), new ArrayList<String>(), species, download.getSpatial().getMatch(), download.getSpatial().getFeature(), (download.getSensitive().equals("sans")), download.getTaxon().getDesignation(), download.getTaxon().getOutput(), download.getTaxon().getOrgSuppliedList(), "", "");
        for (TaxonDatasetWithQueryStats tdwqs : selectRequestableSensitiveObservationDatasetsByFilter) {
            datasets.add(tdwqs.getDatasetKey());
        }
    ...
    public List<Integer> getRecordSet(DownloadFilterJSON download, List<String> species, String dataset, User user) {
        ...
        return taxonObservationMapper.selectRequestableObservationRecordIDsByFilter(user, download.getYear().getStartYear(), download.getYear().getEndYear(), datasets, species, download.getSpatial().getMatch(), download.getSpatial().getFeature(), (download.getSensitive().equals("sans")), download.getTaxon().getDesignation(), download.getTaxon().getOutput(), download.getTaxon().getOrgSuppliedList(), "", "", null);
    }

    public List<Integer> getRecordSet(DownloadFilterJSON download, List<String> species, String dataset, Organisation org) {
        List<String> datasets = new ArrayList<String>();
        datasets.add(dataset);
        return taxonObservationMapper.selectRequestableObservationRecordIDsByFilterOrganisation(org, download.getYear().getStartYear(), download.getYear().getEndYear(), datasets, species, download.getSpatial().getMatch(), download.getSpatial().getFeature(), (download.getSensitive().equals("sans")), download.getTaxon().getDesignation(), download.getTaxon().getOutput(), download.getTaxon().getOrgSuppliedList(), "", "", null);
    }
}