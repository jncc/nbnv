    ...
    <table class="attributeTable">
        <tbody>
            ...
            <tr>
                <th>Date Range</th>
                <td>O</td>
                <td>Lets you define a date range filter using a start and end year. For a full description refer to the <a href="../../Schema_Elements/#DateRange"><code>DateRange</code> an&gt;documentation</a>.</td>
            </tr>
            <tr>
                <th>DatasetList</th>
                <td>O</td>
            ...
            <tr>
                ...
                <td>O</td>
                <td>Lets you filter the species list to an NBN Taxon Reporting Category (e.g. amphibians) using its key. You can only filter by one category.</td>
            </tr>
            <tr>
...
<SpeciesListResponse targetNamespace="http://webservices.searchnbn.net/data" version="1.1" xmlns="http://webservices.searchnbn.net/data" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsd="http://www.w3.org/2001/XMLSchema" termsAndConditions="http://data.nbn.org.uk/help/popups/generalTerms.jsp" NBNLogo="http://data.nbn.org.uk/images/NBNPower.gif" RecordsFound="true" >
	...
	<Species taxonVersionKey="NBNSYS0000002445">
		...
		<TaxonReportingCategory taxonReportingCategoryKey="NHMSYS0000080054">flowering plant</TaxonReportingCategory>
	</Species>
	...
