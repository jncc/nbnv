...
<html>
    <head>
        <title>NBN Gridmap Web Service Version 3.3</title>
        <link href="examples.css" rel="stylesheet" type="text/css" media="screen" />
    </head>
    <body>
        <div id="container">
            <h1>NBN Web Services 3.3 Test page</h1>
     ...
     <%
		...
		//if (server!=null  && server.equals("NBNWEBS-1"))
                ...
                serverURL = new URL(baseUrl, "http://192.171.173.135/ws_3_3/ws/WSDL?WSDL");
		...
		//if (server!=null  && server.equals("NBNWEBS-2"))
            ...
            // test nbnws.net
             if (server==null || server.equals("NBNWS"))
                {
            serverURL = new URL(baseUrl, "http://www.nbnws.net/ws_3_3/ws/WSDL?WSDL");
             gws = new GatewayWebService(serverURL);
