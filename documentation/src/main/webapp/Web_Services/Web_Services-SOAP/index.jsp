...
##Registration
To use the web services you will need to register click [here](Registration).

##WSDL - working with the web services
Here is the WSDL for Gateway Web Services v3.5:

<http://www.nbnws.net/ws_3_5/GatewayWebService?wsdl>

Use it to consume the web services in your environment.

To help you we provide client libraries derived from this wsdl. These are available [here](Working_with_the_Web_Services).
