...
<t:webserviceDocumentationPage>
    ...
    <jsp:attribute name="body">
        <div class="nbn-atlas-documentation-section">
            ...
            <nbn:prettyprint-code lang="url">http://gis.nbn.org.uk/arcgis/atlas/SingleSpeciesMap/&lt;TAXONVERSIONKEY&gt;/&lt;service&gt;</nbn:prettyprint-code>
        ...
        <div class="nbn-atlas-documentation-section">
            ...
            <ul class="section-parameters-list">
                ...
                <li class="parameter-section">
                    ...
                    <nbn:prettyprint-code lang="url">http://gis.nbn.org.uk/arcgis/atlas/SingleSpeciesMap/NBNSYS0000000009/map?datasets=GA000623,GA000652</nbn:prettyprint-code>
                </li>
                <li class="parameter-section">
...
private static String getHashText(String password) throws NoSuchAlgorithmException{
    ...
    return hashtext;
                ...
                <li class="parameter-section">
                    ...
                    <nbn:prettyprint-code lang="url">http://gis.nbn.org.uk/arcgis/atlas/SingleSpeciesMap/NHMSYS0000459714/map?fillcolour=00ffff&outlinecolour=e2e2e2</nbn:prettyprint-code>
                ...
                <li class="parameter-section">
                    ...
                    <nbn:prettyprint-code lang="url">http://gis.nbn.org.uk/arcgis/atlas/SingleSpeciesMap/NHMSYS0000459714/map?format=gif</nbn:prettyprint-code>
                </li>
                <li class="parameter-section">
                    <h2>css</h2>
...
<body>
    <table class="nbn-acknowledgment-table">
        ...
        <tr class="nbn-acknowledgment-entryRow">
            <td class="nbn-acknowledgment-datasetTitle">
                <a href="http://data.nbn.org.uk/datasetInfo/taxonDataset.jsp?dsKey=GA000477">
                    ...
                    <iframe src="http://gis.nbn.org.uk/arcgis/atlas/SingleSpeciesMap/NHMSYS0000459714/acknowledgement" height="300" width="500"></iframe>
                </li>
            </ul>
        </div>
        ...
        <div class="nbn-atlas-documentation-section">
            ...
            <div>
                <nbn:prettyprint-code lang="url">http://gis.nbn.org.uk/arcgis/atlas/SingleSpeciesMap/NHMSYS0000459714/map?background=gb100kgrid&startyear=1990&endyear=2000&fillcolour=00ffff&outlinecolour=000000&imagesize=14&format=gif&datasets=GA000091,GA000482</nbn:prettyprint-code>
                <p class="description"></p>
                <img height="405" width="300" src="http://gis.nbn.org.uk/arcgis/atlas/SingleSpeciesMap/NHMSYS0000459714/map?background=gb100kgrid&startyear=1990&endyear=2000&fillcolour=00ffff&outlinecolour=000000&imagesize=9&format=gif&datasets=GA000091,GA000482">
            </div>
        </div>
    </jsp:attribute>
</t:webserviceDocumentationPage>
