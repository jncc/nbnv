    ...
    <form action="" method="post" id="nbn-site-report-form">
        ...
        <div class="nbn-report-data-container">
            ...
            <#list taxaWithQueryStats as taxonWithQueryStats>
                <tr><td class="nbn-td-left nbn-td-right"><a href="/Reports/Sites/${featureID}/Groups/${taxonOutputGroupKey}/Species/${taxonWithQueryStats.taxon.prefnameTaxonVersionKey}/Observations${report_utils.getQueryParameterText(RequestParameters)}"><@taxon_utils.short_name taxon=taxonWithQueryStats.taxon/></a> (${taxonWithQueryStats.querySpecificObservationCount})</td></tr>
            </#list>
            </table>
        </div>
