...
<#assign title=taxonOutputGroup.taxonGroupName?cap_first + " species with records for the 10km square ${tenkmGridRef} from ${report_utils.getYearRangeText(RequestParameters)}">
