...
<@template.master title="10km report for ${tenkmGridRef}" javascripts=["/js/site-report-form-validation.js"]>
    ...
    <@location_report_content.observations title=title locationName=tenkmGridRef locationID=tenkmGridRef datasets=datasets requestParameters=RequestParameters taxon=taxon/>
</@template.master>
