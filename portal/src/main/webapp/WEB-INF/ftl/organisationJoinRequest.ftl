...
<div id="nbn-org-join-request-actions" class="tabbed nbn-organisation-tabbed">
        ...
        <div id="nbn-org-join-action" data-requestor="true">
            <#switch request.responseTypeID>
                <#case 0>
                    ...
                    <input id="nbn-org-join-withdraw" data-id="${request.id?c}" data-url="${api}/organisationMemberships/request/${request.id?c}" type="button" value="Withdraw this request" />
    ...
    <#else>
        <div id="nbn-org-join-action" data-id=${request.id?c}>
            <#switch request.responseTypeID>
                <#case 0>
                    <input id="nbn-org-join-accept" data-url="${api}/organisationMemberships/request/${request.id?c}" type="button" value="Accept" />
                    <input id="nbn-org-join-decline" data-url="${api}/organisationMemberships/request/${request.id?c}" type="button" value="Decline" />
