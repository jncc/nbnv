<@template.master title="NBN Gateway - Organisations Administration"
    javascripts=["/js/enable-dataset-metadata-tabs.js","/js/jquery.dataTables.min.js","/js/orgAdmin/enable-users-datatable.js","/js/orgAdmin/enable-join-datatable.js","/js/orgAdmin/enable-direct-add-user.js","/js/jquery.validate.min.js","/js/orgAdmin/enable-metadata-edit.js","/js/dialog_spinner.js","/js/dialog_utils.js"]
    csss=["/css/organisation.css","/css/org-admin.css","/css/dialog-spinner.css"]>
...
<#macro parseUsers userList>
    ...
    <#list userList as obj>
        <#assign users = users + [{"key": obj.user.id, "name": obj.user.forename + " " + obj.user.surname, "email": obj.user.email, "role": obj.role}]/>
    </#list>
