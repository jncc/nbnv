 ...
 * @date    19-Nov-2010
 */
public class AutoCompleteTaxonSearchJSON extends HttpServlet {
	...
	PrintWriter out = response.getWriter();
	    ...
	    try {
		List<SearchMatch<Taxon>> searchResults = dao.searchTaxon(request.getParameter(SEARCH_PARAMETER));
		SearchedTaxonMatchToJSONObjectBridge<Taxon> bridge = new SearchedTaxonMatchToJSONObjectBridge<Taxon>();
		ListBridge<SearchMatch<Taxon>, JSONObject> listBridge = new ListBridge<SearchMatch<Taxon>, JSONObject>(bridge);
