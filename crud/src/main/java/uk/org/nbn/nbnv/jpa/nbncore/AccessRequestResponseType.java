 ...
 */
@Entity
@Table(name = "AccessRequestResponseType")
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "AccessRequestResponseType.findAll", query = "SELECT a FROM AccessRequestResponseType a"),
    @NamedQuery(name = "AccessRequestResponseType.findById", query = "SELECT a FROM AccessRequestResponseType a WHERE a.id = :id"),
    @NamedQuery(name = "AccessRequestResponseType.findByLabel", query = "SELECT a FROM AccessRequestResponseType a WHERE a.label = :label")})
public class AccessRequestResponseType implements Serializable {
    ...
    public AccessRequestResponseType(Integer id) {
        this.id = id;
    }

    public AccessRequestResponseType(Integer id, String label) {
        this.id = id;
        this.label = label;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof AccessRequestResponseType)) {
            return false;
        }
        AccessRequestResponseType other = (AccessRequestResponseType) object;
    ...
    public String toString() {
        return "uk.org.nbn.nbnv.jpa.nbncore.AccessRequestResponseType[ id=" + id + " ]";
    }
